    ...
    <div className="min-h-screen bg-blue-50 pt-24 pb-20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
          <div>
            <p className="text-gray-700 leading-relaxed text-lg mb-6">{desc1}</p>
          ...
          {about.photo ? (
            ...
            <div className="rounded-2xl bg-white border border-gray-200 p-8 font-mono text-sm space-y-3">
              <div className="text-gray-400 text-xs mb-4">// Mission</div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-6">
          {[
            { icon: <MapPin className="text-blue-600" size={24} />, labelSq: "Projekte GIS", labelEn: "GIS Projects", value: "10+" },
            ...
            <div key={i} className="rounded-2xl bg-white border border-gray-200 p-6 text-center">
              ...
              <div className="text-gray-500 text-sm">{locale === "sq" ? item.labelSq : item.labelEn}</div>
            </div>
          ))}
        </div>
      </div>
